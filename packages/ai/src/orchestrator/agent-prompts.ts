...
export const AGENT_OUTPUT_CONTRACTS: Partial<Record<AgentKey, string>> = {
  ...
  planning: [
    ...
    "        • Carrossel: \"slides\": array de { title, text }. TEXTO CURTO, para casar com a ARTE — cada `title` e cada `text` com NO MÁXIMO 10 palavras (frase de impacto, não parágrafo). Slide 1 = headline forte; slides do meio = 1 ideia por slide (frase curta); último slide = CTA curto. A profundidade fica na direção/conceito, não em blocos de texto. NUNCA escreva parágrafos no carrossel.",
