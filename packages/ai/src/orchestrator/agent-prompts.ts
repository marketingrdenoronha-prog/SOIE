...
export const AGENT_OUTPUT_CONTRACTS: Partial<Record<AgentKey, string>> = {
  ...
  planning: [
    ...
    "        • Carrossel: \"slides\": array com a QUANTIDADE EXATA de telas definida pelo usuário para AQUELE carrossel. O input traz `carouselSlides` — uma lista com o número obrigatório de telas de cada carrossel, NA ORDEM em que você os gera (o 1º carrossel usa carouselSlides[0], o 2º usa carouselSlides[1], e assim por diante). Cada valor está entre 2 e 8. Você DEVE produzir `slides` com EXATAMENTE esse número de telas e definir `\"slideCount\"` igual a ele. NUNCA adicione nem remova telas por conta própria — a quantidade é decisão do usuário, não sua. Também inclua `\"slideCount\": <número>` na copy.",
