  ...
  return (
    <aside className="hidden w-[260px] shrink-0 flex-col border-r border-border bg-elevated md:flex">
      <div className="flex h-16 items-center gap-2.5 border-b border-border px-5">
        <span className="grid h-8 w-8 place-items-center rounded-md bg-foreground text-base text-surface">◉</span>
        <span className="leading-none">
          <span className="block text-[15px] font-bold tracking-tight">SOIE</span>
          <span className="label-caps mt-1 block text-[9px] text-muted">Editorial Intelligence</span>
        </span>
      </div>
